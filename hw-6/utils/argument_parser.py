...
def parse_arguments() -> Tuple[str, int, int, int]:
    ...
    parser.add_argument("learning_data_percentage", help="percentage of data that should be used as learning data")
    args = parser.parse_args()
    return args.input_dir, int(args.judgement_year), int(args.replace_n), int(args.learning_data_percentage)
